...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('ContactUsList', function () {
        return view('ContactUsList');
    });
    Route::get('GetAQuoteList', function () {
        return view('GetAQuoteList');
    });
    Route::get('CarrersListApplyJob', function () {
        return view('CarrersListApplyJob');
    });
