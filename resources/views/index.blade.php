...
@section('meta_title', '')
@section('meta_description', 'Transform your online presence with Maastrix Solutions’ complete web solutions — expert web design, development, SEO, and digital marketing that drives traffic, engagement, and growth')
@section('meta_keyword', 'custom website development company in the USA,ecommerce website development agency in the
                                ...
                                <div class="row">
                                    <div class="col-lg-5 col-md-5">
                                        <div class="pro_img_sec">
                                            <img src="{{ url('Home_banner_card_images/'.$card->image) }}" alt="" title="">
                                        </div>
                                    </div>
                ...
                <div class="service-card style4">
                    <div class="service-info">
                        <div class="service-title">
                            <span>
                                <img src="{{url('home_section2/'.$contnts->image)}}" alt="" title="">
                            </span>
                            <h3>
                                {{$contnts->heading}}
                            </h3>
                        ...
                        <p><?php $con = $contnts->content1;
                            ...
                            echo $con1 . "...";
                            ?></p>
                        <a href="{{url('Services_view/'.$contnts->id)}}" class="link style1">More Info <i class="fas fa-chevron-double-right"></i>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 mx-auto">
                <div class="recent_work_sec_head">
                    ...
                    <a href="{{url('portfolio')}}" class="all_projects"><i class="fas fa-long-arrow-alt-right"></i>View All Projects</a>
                </div>
                <div class="recent_work_sec_body">
                    ...
                    <div class="recent_work_sec_body_single">
                        ...
                        <a href="{{url('portfolio-view/'.$portfolio->id)}}" portfolio-id="{{$portfolio->id}}" portfolio-heading="{{$portfolio->heading}}" portfolio-content="{{$portfolio->content}}" portfolio-image="{{$portfolio->image}}">
            ...
            <div class="col-lg-12 col-md-12">
                ...
                <div class="client_logo_sec_main owl-carousel" id="logo_banner">
                    ...
                    <div class="client_logo_sec_single">
                        <img src="{{url('Client_images/'.$clint_logo->client_image)}}" alt="" title="">
                    </div>
                    @endforeach
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 wow fadeInLeftBig" data-wow-duration="1.4s">
                            <div class="next_level_sec_img">
                                ...
                                <img src="{{url('whychooseus/'.$why_chose->image)}}" alt="" title="">
                            </div>
                        </div>
                            ...
                            <div class="next_level_sec_img_cont">
                                <div class="sub_title">
                                    ...
                                    <div class="get_btn_sec">
                                        <a href="contact-form" class="get_start_btn"><i class="fas fa-file-pdf"></i>Get A Quote</a>
                                        <a href="{{url('contact-us')}}" class="talk_btn"><i class="fas fa-phone-alt"></i>Let's Talk</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-7 col-md-7 wow fadeInDown" data-wow-duration="1.4s">
                            <div class="we_believe_left_main">
                                <div class="we_believe_left">
                                    <img src="images/believe.jpg" alt="" title="" style="display: none;">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="we_believe_right">
                                <div class="we_believe_right_inner">
                                    <div class="we_believe_right_inner_head">
                                        ...
                                        <nav>
                                            <div class="believe_tabs nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                                <a class="nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Who We Are</a>
                                                <a class="nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Our Team</a>
                                                <a class="nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">How We Work</a>
                                            </div>
                                        </nav>
                                            ...
                                            <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                                                <div class="tab_cont_sec">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-8 col-md-8">
                                                            <div class="tab_right_cont">
                                                                <p>Unlike other, we have different style of work. Our project managers, engineers, and designers develop well-defined solutions that are focused on your challenges/pains. We know your web requirement is unique, as are your needs and objectives.</p>
                                                                <!-- <ul>
                                                                    <li><i class="far fa-check-circle"></i></li>
                                                                    <li><i class="far fa-check-circle"></i></li>
                                                                </ul> -->
...
<div class="sticky-profile"><button class="btn-3" data-toggle="modal" data-target="#myModal"><i class="fas fa-download"></i> &nbsp;Download Profile</button></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="download-profile-pics"><img src="images/profile-download.jpg" alt="" /></div>
                    </div>
                    <div class="col-lg-6">
                        <div class="download-profile-form">
                            ...
                            <ul>
                                <li><input type="text" class="form-control" name="name" id="nameID" placeholder="Name"><i class="far fa-user"></i></li>
                                <li><input type="text" class="form-control" name="email" id="emailID" placeholder="Email"><i class="fal fa-envelope"></i></li>
                                <li><input type="text" class="form-control" name="phone" id="phoneID" placeholder="Phone"><i class="fal fa-phone-alt"></i></li>
                                <li><textarea class="form-control" name="msg" id="msgID" placeholder="Enter Your Message..."></textarea><i class="fal fa-comments-alt"></i></li>
                                <li><button type="button" class="get_start_btn btn-submit" name="submit" value="Submit">Submit</button></li>
                            </ul>
                        </div>
                        ...
                        <div class="download-profile-form-success d-none">
                            ...
                            <a href="{{('/profiledetails/Maastrix_Profile.pdf')}}" download><button class="get_start_btn btn-submit">Click Here to Download profile</button></a>
...
<script>
    function open_modal(obj) {
        ...
        $('#portfolio_img').html(`<img class="home-recentwork" src="Portfolio_images/${portfolio_image}" height="150px" width="264px">`);
    }
</script>
<script type="text/javascript">
    const btn =
