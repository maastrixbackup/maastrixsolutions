                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="portfolio_sec_main portfolio-contents">
                            <nav>
                                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                    ...
                                    <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile"
                                        role="tab" aria-controls="nav-profile" aria-selected="false">Word Press</a>
                                    <a class="nav-item nav-link" id="nav-phal-tab" data-toggle="tab" href="#nav-phal"
                                        role="tab" aria-controls="nav-phal" aria-selected="false">Phalcon</a>
                                    <a class="nav-item nav-link" id="nav-laravel-tab" data-toggle="tab" href="#nav-laravel"
                                        role="tab" aria-controls="nav-laravel" aria-selected="false">Laravel</a>
                                    <a class="nav-item nav-link" id="nav-yii-tab" data-toggle="tab" href="#nav-yii"
                                        role="tab" aria-controls="nav-yii" aria-selected="false">Yii</a>
                                    <a class="nav-item nav-link" id="nav-react-tab" data-toggle="tab" href="#nav-react"
                                        role="tab" aria-controls="nav-react" aria-selected="false">React</a>
                                    <a class="nav-item nav-link" id="nav-flyer-tab" data-toggle="tab" href="#nav-flyer"
                                        role="tab" aria-controls="nav-flyer" aria-selected="false">Flyer</a>
                                    <a class="nav-item nav-link" id="nav-logo-tab" data-toggle="tab" href="#nav-logo"
                                        role="tab" aria-controls="nav-logo" aria-selected="false">Logo</a>
                                    <a class="nav-item nav-link" id="nav-mobile-tab" data-toggle="tab" href="#nav-mobile"
                                        role="tab" aria-controls="nav-mobile" aria-selected="false">Mobile App</a>
                                    <a class="nav-item nav-link" id="nav-nextjs-tab" data-toggle="tab" href="#nav-nextjs"
                                        role="tab" aria-controls="nav-nextjs" aria-selected="false">Next.js</a>
                                    <a class="nav-item nav-link" id="nav-nodejs-tab" data-toggle="tab" href="#nav-nodejs"
                                        role="tab" aria-controls="nav-nodejs" aria-selected="false">Node.js</a>
                                </div>
                            </nav>
                            <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                                            ...
                                            @foreach ($portfolio as $portfolio_all)
                                                <div class="col-lg-4 col-md-4 list-item">
                                                    <div class="sc-project-item sc-mb-15">
                                                        <img src="{{ url('Portfolio_images/' . $portfolio_all->image) }}"
                                                            alt="" title="">
                                                        <div class="sc-project-content-box">
                                                            <div class="sc-project-icon">
                                                                <a class="thumbnail"
                                                                    href="{{ url('portfolio-view/' . $portfolio_all->id) }}"
                                                                    data-image-id=""
                                                                    data-image="{{ url('images/portfolio/Interior-Decoration.jpg') }}"><i
                                                                        class="fal fa-long-arrow-right"></i></a>
                                                            </div>
                                                            <div class="sc-project-text">
                                                                <span
                                                                    class="sub-title">{{ $portfolio_all->heading }}</span>
                                                                <h4><a class="title"
                                                                        href="{{ url('portfolio-view/' . $portfolio_all->id) }}">{{ $portfolio_all->heading }}</a>
                                                                </h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="tab_cont_main">
                                        <div class="row">
                                            @foreach ($port_wordpress as $wordpress)
                                                <div class="col-lg-4 col-md-4 list-item">
                                                    <div class="sc-project-item sc-mb-15">
                                                        <img src="{{ url('Portfolio_images/' . $wordpress->image) }}"
                                                            alt="" title="">
                                                        <div class="sc-project-content-box">
                                                            <div class="sc-project-icon">
                                                                <a class="thumbnail"
                                                                    href="{{ url('portfolio-view/' . $wordpress->id) }}"
                                                                    data-image-id=""
                                                                    data-image="{{ url('Portfolio_images/' . $wordpress->image) }}"><i
                                                                        class="fal fa-long-arrow-right"></i></a>
                                                            </div>
                                                            <div class="sc-project-text">
                                                                <span class="sub-title">{{ $wordpress->heading }}</span>
                                                                <h4><a class="title"
                                                                        href="#">{{ $wordpress->heading }}</a></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="tab-pane fade" id="nav-flyer" role="tabpanel"
                                    aria-labelledby="nav-flyer-tab">
                                    <div class="tab_cont_main">
                                        <div class="row">
                                            @foreach ($port_flyer as $flyer)
                                                <div class="col-lg-4 col-md-4 thumb">
                                                    <div class="sc-project-item sc-mb-15">
                                                        <img src="{{ url('Portfolio_images/small_flyer/' . $flyer->image) }}"
                                                            alt="" title="">
                                                        <div class="sc-project-content-box">
                                                            <div class="sc-project-icon">
                                                                <a class="thumbnail" href="#" data-image-id="1"
                                                                    data-toggle="modal" data-title=""
                                                                    data-image="{{ url('Portfolio_images/large_flyer/' . $flyer->large_image) }}"
                                                                    data-target="#image-gallery"><i
                                                                        class="fal fa-long-arrow-right"></i></a>
                                                            </div>
                                                            <div class="sc-project-text">
                                                                <span class="sub-title">{{ $flyer->heading }}</span>
                                                                <h4><a class="title"
                                                                        href="#">{{ $flyer->heading }}</a></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="tab_cont_main">
                                        <div class="row">
                                            @foreach ($port_logo as $logo)
                                                <div class="col-lg-4 col-md-4 thumb">
                                                    <div class="sc-project-item sc-mb-15">
                                                        <img src="{{ url('Portfolio_images/logo/' . $logo->image) }}"
                                                            alt="" title="">
                                                        <div class="sc-project-content-box">
                                                            <div class="sc-project-icon">
                                                                <a class="thumbnail" href="#" data-image-id="1"
                                                                    data-toggle="modal" data-title=""
                                                                    data-image="{{ url('Portfolio_images/logo/' . $logo->large_image) }}"
                                                                    data-target="#image-gallery"><i
                                                                        class="fal fa-long-arrow-right"></i></a>
                                                            </div>
                                                            <div class="sc-project-text">
                                ...
                                <div class="tab-pane fade" id="nav-phal" role="tabpanel"
                                    aria-labelledby="nav-phal-tab">
                                    <div class="tab_cont_main">
                                        <div class="row">
                                            @foreach ($port_phalcon as $phalcon)
                                                <div class="col-lg-4 col-md-4 list-item">
                                                    <div class="sc-project-item sc-mb-15">
                                                        <img src="{{ url('Portfolio_images/' . $phalcon->image) }}"
                                                            alt="" title="">
                                                        <div class="sc-project-content-box">
                                                            <div class="sc-project-icon">
                                                                <a class="thumbnail"
                                                                    href="{{ url('portfolio-view/' . $phalcon->id) }}"
                                                                    data-image-id=""
                                                                    data-image="{{ url('Portfolio_images/' . $phalcon->image) }}"><i
                                                                        class="fal fa-long-arrow-right"></i></a>
                                                            </div>
                                                            <div class="sc-project-text">
                                                                <span class="sub-title">{{ $phalcon->heading }}</span>
                                                                <h4><a class="title"
                                                                        href="#">{{ $phalcon->heading }}</a></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="tab-pane fade" id="nav-laravel" role="tabpanel"
                                    aria-labelledby="nav-laravel-tab">
                                    <div class="tab_cont_main">
                                        <div class="row">
                                            @foreach ($port_laravel as $laravel)
                                                <div class="col-lg-4 col-md-4 list-item">
                                                    <div class="sc-project-item sc-mb-15">
                                                        <img src="{{ url('Portfolio_images/' . $laravel->image) }}"
                                                            alt="" title="">
                                                        <div class="sc-project-content-box">
                                                            <div class="sc-project-icon">
                                                                <a class="thumbnail"
                                                                    href="{{ url('portfolio-view/' . $laravel->id) }}"
                                                                    data-image-id=""
                                                                    data-image="{{ url('Portfolio_images/' . $laravel->image) }}"><i
                                                                        class="fal fa-long-arrow-right"></i></a>
                                                            </div>
                                                            <div class="sc-project-text">
                                                                <span class="sub-title">{{ $laravel->heading }}</span>
                                                                <h4><a class="title"
                                                                        href="#">{{ $laravel->heading }}</a></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="tab_cont_main">
                                        <div class="row">
                                            @foreach ($port_yii as $yii)
                                                <div class="col-lg-4 col-md-4 list-item">
                                                    <div class="sc-project-item sc-mb-15">
                                                        <img src="{{ url('Portfolio_images/' . $yii->image) }}"
                                                            alt="" title="">
                                                        <div class="sc-project-content-box">
                                                            <div class="sc-project-icon">
                                                                <a class="thumbnail"
                                                                    href="{{ url('portfolio-view/' . $yii->id) }}"
                                                                    data-image-id=""
                                                                    data-image="{{ url('Portfolio_images/' . $yii->image) }}"><i
                                                                        class="fal fa-long-arrow-right"></i></a>
                                                            </div>
                                                            <div class="sc-project-text">
                                                                <span class="sub-title">{{ $yii->heading }}</span>
                                                                <h4><a class="title"
                                                                        href="#">{{ $yii->heading }}</a></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="tab_cont_main">
                                        <div class="row">
                                            @foreach ($port_react as $react)
                                                <div class="col-lg-4 col-md-4 list-item">
                                                    <div class="sc-project-item sc-mb-15">
                                                        <img src="{{ url('Portfolio_images/' . $react->image) }}"
                                                            alt="" title="">
                                                        <div class="sc-project-content-box">
                                                            <div class="sc-project-icon">
                                                                <a class="thumbnail"
                                                                    href="{{ url('portfolio-view/' . $react->id) }}"
                                                                    data-image-id=""
                                                                    data-image="{{ url('Portfolio_images/' . $react->image) }}"><i
                                                                        class="fal fa-long-arrow-right"></i></a>
                                                            </div>
                                                            <div class="sc-project-text">
                                                                <span class="sub-title">{{ $react->heading }}</span>
                                                                <h4><a class="title"
                                                                        href="#">{{ $react->heading }}</a></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="tab_cont_main">
                                        <div class="row">
                                            @foreach ($port_mobile as $mobile)
                                                <div class="col-lg-4 col-md-4 thumb">
                                                    <div class="sc-project-item sc-mb-15">
                                                        <img src="{{ url('Portfolio_images/mobileapp/' . $mobile->image) }}"
                                                            alt="" title="">
                                                        <div class="sc-project-content-box">
                                                            <div class="sc-project-icon">
                                                                <a class="thumbnail" href="#" data-image-id="1"
                                                                    data-toggle="modal" data-title=""
                                                                    data-image="{{ url('Portfolio_images/mobileapp/' . $mobile->large_image) }}"
                                                                    data-target="#image-gallery"><i
                                                                        class="fal fa-long-arrow-right"></i></a>
                                                            </div>
                                                            <div class="sc-project-text">
                                ...
                                <div class="tab-pane fade" id="nav-nextjs" role="tabpanel"
                                    aria-labelledby="nav-nextjs-tab">
                                    <div class="tab_cont_main">
                                        <div class="row">
                                            @foreach ($port_next as $next)
                                                <div class="col-lg-4 col-md-4 thumb">
                                                    <div class="sc-project-item sc-mb-15">
                                                        <img src="{{ url('Portfolio_images/' . $next->image) }}"
                                                            alt="" title="">
                                                        <div class="sc-project-content-box">
                                                            <div class="sc-project-icon">
                                                                <a class="thumbnail" href="#" data-image-id="1"
                                                                    data-toggle="modal" data-title=""
                                                                    data-image="{{ url('Portfolio_images/' . $next->large_image) }}"
                                                                    data-target="#image-gallery"><i
                                                                        class="fal fa-long-arrow-right"></i></a>
                                                            </div>
                                                            <div class="sc-project-text">
                                                                <span class="sub-title">{{ $next->type }}</span>
                                                                <h4><a class="title"
                                                                        href="#">{{ $next->heading }}</a></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="tab-pane fade" id="nav-nodejs" role="tabpanel"
                                    aria-labelledby="nav-nodejs-tab">
                                    <div class="tab_cont_main">
                                        <div class="row">
                                            @foreach ($port_node as $node)
                                                <div class="col-lg-4 col-md-4 thumb">
                                                    <div class="sc-project-item sc-mb-15">
                                                        <img src="{{ url('Portfolio_images/' . $node->image) }}"
                                                            alt="" title="">
                                                        <div class="sc-project-content-box">
                                                            <div class="sc-project-icon">
                                                                <a class="thumbnail" href="#" data-image-id="1"
                                                                    data-toggle="modal" data-title=""
                                                                    data-image="{{ url('Portfolio_images/' . $node->large_image) }}"
                                                                    data-target="#image-gallery"><i
                                                                        class="fal fa-long-arrow-right"></i></a>
                                                            </div>
                                                            <div class="sc-project-text">
                                                                <span class="sub-title">{{ $node->type }}</span>
                                                                <h4><a class="title"
                                                                        href="#">{{ $node->heading }}</a></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
