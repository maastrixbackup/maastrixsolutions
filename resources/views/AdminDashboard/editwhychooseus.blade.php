        ...
        <div class="col-lg-12 col-md-12">
          <div class="admin_user_head">
            <div class="admin_user_head_tag">
              <h1 class="m-0 text-dark">Manage Page Why Choose Us</h1>
            </div>
        ...
        <div class="col-lg-12">
          ...
          <div class="">
            <div class="card-body">
              ...
              <form method="POST" id="upload-file" action="{{ url('whychooseusupdate/'.$profiles->id) }}">
                      <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">   
                      <div class="form-group">
                        <label for="exampleInputEmail1">Heading</label>
                        <input type="text" name="heading" class="form-control" id="heading" placeholder="Enter Heading" value="{{$profiles->heading}}">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">SubHeading</label>
                        <input type="text" name="sub_heading" class="form-control" id="sub_heading" placeholder="Enter Sub-Heading" value="{{$profiles->sub_heading}}">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Content</label>
                        <textarea name="content" class="form-control" id="content" placeholder="Enter Sub-Heading">{{$profiles->content}}</textarea>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Points</label>
                        <textarea name="points" class="form-control" id="points" placeholder="Enter Banner Sub-Heading">{{$profiles->points}}</textarea>
                      </div>    
