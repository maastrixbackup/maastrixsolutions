          ...
          <div class="">
            <div class="card-body">
              @foreach($testimonial_details as $testimonial)
                <form method="POST" enctype="multipart/form-data" id="testinomial-form" action="{{ url('updatetestimonial/'.$testimonial->id) }}">
                      <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>"> 
                     <label>   
                      <div class="form-group">
                        <label for="exampleInputEmail1">Name</label>
                        <input type="text" name="name" class="form-control" id="name" placeholder="Enter your Name" value="{{$testimonial->name}}">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Remark  </label>
                        <input type="text" name="remark" class="form-control" id="remark" placeholder="Enter your Remark" value="{{$testimonial->remark}}">
                      </div>
<!--                       <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="country" class="form-control" id="country" placeholder="Enter your Country" value="{{$testimonial->country}}">
                      </div>
