        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Details of Job Posted</h3>
            </div>
            <div class="card-body">
              <h2><u>Job- Title:</u><br>{{$job->job_title}}</h2>
                <h6><u>Job Description:</u><br>{{$job->job_description}}</h6>
                <h6><u>Job Location:</u><br>{{$job->location}}</h6>
            </div>
          </div>
          @endforeach
        </div>
