        ...
        <div class="col-lg-12 col-md-12">
          <div class="admin_user_head">
            <div class="admin_user_head_tag">
              <h1 class="m-0 text-dark">Admins User Management</h1>
            </div>
            <div class="admin_user_head_cont">
              <ul>
                <li><a href="" class="active">Home</a></li>
                <li>/</li>
                <li><a href="">Admins User Management</a></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="">
            <div class="card-body">
              <a class="btn btn-info" href="">Add New Admin</a><br><br><table class="table table-bordered">
                <thead>
                  <tr>
