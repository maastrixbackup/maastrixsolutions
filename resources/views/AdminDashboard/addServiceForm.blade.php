    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="">
            <div class="card-body">
              <form method="POST" enctype="multipart/form-data" id="upload-file" action="{{ url('saveservice') }}">
                      <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">   
          
                      <div class="form-group">
                        <label for="exampleInputEmail1">Heading</label>
                        <input type="text" name="heading" class="form-control" id="heading" placeholder="Enter Service Heading">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Contents</label>
                        <textarea name="content" class="form-control" id="content" placeholder="Enter Service content"></textarea>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Points</label>
                        <textarea name="  points" class="form-control" id=" points" placeholder="Enter Service  points"></textarea>
                      </div>
                      <div class="form-group">
