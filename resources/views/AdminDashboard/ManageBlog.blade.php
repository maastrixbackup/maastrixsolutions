    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="">
            <div class="card-body">
              <a class="btn btn-info" href="{{url('add-blog')}}">Add New Blog</a><br><br>
             <table class="table table-bordered" id="banner_table">
                ...
                <tbody>
                 ...
                 <td><img src="{{url('blog_images/'.$blog->image)}}" width="30px" height="35px"></td>  
                 <td>
                   <a class="btn btn-app" href="{{url('edit-blog/'.$blog->id)}}" style="height:38px;min-width:20px;padding: 8px 5px;">
                        <i class="fas fa-edit"></i> 
                    </a>
                    <a class="btn btn-app" href="{{url('delete-blog/'.$blog->id)}}" style="height:38px;min-width:20px;padding: 8px 5px;">
                        <i class="fas fa-trash"></i> 
                    </a>
                    <a class="btn btn-app" href="{{url('view-blog/'.$blog->id)}}" style="height:38px;min-width:20px;padding: 8px 5px;">
