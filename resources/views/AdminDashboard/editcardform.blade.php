        ...
        <div class="col-lg-12">
          ...
          <div class="">
            <div class="card-body">
              ...
              <form method="POST" id="upload-file" action="{{ url('updatecard/'.$card->id) }}">
                      <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">   
                      <div class="form-group">
                        <label for="card_heading">Card Heading</label>
                        <input type="text" name="card_heading" class="form-control" id="card_heading" placeholder="Enter Card Heading" value="{{$card->card_heading}}">
                      </div>
                      <div class="form-group">
                        <label for="card_sub_heading">Card SubHeading</label>
                        <input type="text" name="card_sub_heading" class="form-control" id="card_sub_heading" placeholder="Enter Card Sub-Heading" value="{{$card->card_sub_heading}}">
                      </div>
