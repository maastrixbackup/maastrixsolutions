        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Add New Questionnaire</h3>
            </div>
          </div>
          <div class="">
            <div class="card-body">
              <form method="POST" enctype="multipart/form-data" id="upload-file" action="{{ url('saveQuestionnaire') }}">
                      <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>"> 
                      <div class="form-group">
                        <label for="fld_cat">Field category</label>
                        <input type="text" name="fld_cat" class="form-control" id="fld_cat" placeholder="Enter Field Category">
                      </div>
                      <div class="form-group">
                        <label for="fld_cat">Type</label>
                        <input type="text" name="type" class="form-control" id="type" placeholder="Enter Development Type">
                      </div>
                      <div class="form-group">
                        <label for="fld_name">Field Name</label>
                        <input type="text" name="fld_name" class="form-control" id="fld_name" placeholder="Enter Field Name">
                      </div>
                      <div class="form-group">
                        <label for="fld_type">Field Type</label>
                        <input type="text" name="fld_type" class="form-control" id="fld_type" placeholder="Enter Field Type">
                      </div>
                      <div class="form-group">
                        <label for="fld_type">Placeholder</label>
                        <input type="text" name="placeholder" class="form-control" id="placeholder" placeholder="Enter placeholder">
                      </div>
                      <div class="form-group">
                        <label for="fld_type">Input Name</label>
                        <input type="text" name="input_name" class="form-control" id="input_name" placeholder="Enter Input Name">
                      </div>
