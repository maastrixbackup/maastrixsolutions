...
<div class="wrapper">
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12">
          ...
          <div class="admin_user_head_tag">
              <h1 class="m-0 text-dark">Faq View</h1>
            </div>
            <div class="admin_user_head_cont">
              <ul>
                <li><a href="" class="active">Home</a></li>
                <li>/</li>
                <li><a href=""></a>Faq View</li>
              </ul>
            </div>
          </div>
        </div>
  ...
  <section class="admin_user_table">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12">
          @foreach($view_faq as $faq)
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Details of Faq's</h3>
            </div>
            <div class="card-body">
              <h3><u>Question:</u></h3>{{$faq->question}}
                <h3><u>Answer:</u></h3>{{$faq->answer}}
            </div>
          </div>
          @endforeach
        </div>
